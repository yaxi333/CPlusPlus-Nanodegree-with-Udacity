...
Renderer::Renderer(const std::size_t screen_width,
  ...
  SDL_StartTextInput();
  printf("Please enter the inital speed level: (0 - 9 getting faster with the higher number)\n");
  // Create renderer
...
void Renderer::Render(Snake const &snake, AISnake const &ai_snake, SDL_Point const &food, SDL_Point const &obstacle) {
  SDL_Rect block;
